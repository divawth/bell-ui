      ...
      'text',
      {
        watcher: function () {
          this.nextTick(function () {
            var scale = elWidth / this.$refs.textStr.clientWidth; 
            this.set(
              'transformStyle',
