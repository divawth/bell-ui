...
(function (global, factory) {
  ...
  var template$p = (function(){var $0=void 0,$5={className:'bell-select-group-title'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__l,__m,__j,__k){__j[__j.length]=_a({context:_x,nativeProps:{className:'bell-select-option-group'+(_o('className',__l.className).value?' '+_w(_o('className',__l.className).value):'')},tag:'div',type:3},function(__i){_o('style',__l.style).value?_c(__i,'nativeProps',_o('style',__l.style).value,'style.cssText'):$0;},function(__j){__j[__j.length]={context:_x,nativeProps:$5,tag:'div',text:_w(_o('label',__l.label).value),type:3};_j('$slot_'+'children',__j);});}})();
  ...
  var template$x = (function(){var $0=void 0,$2=!0,$5={className:'bell-badge-dot'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__l,__m,__j,__k){__j[__j.length]=_a({context:_x,nativeProps:{className:'bell-badge'+(_o('status',__l.status).value?'-status':'')+(_o('status',__l.status).value?' bell-badge-status-'+_w(_o('status',__l.status).value):_o('type',__l.type).value?' bell-badge-'+_w(_o('type',__l.type).value):'')+(_o('dot',__l.dot).value&&_o('text',__l.text).value?' bell-badge-with-dot-text':'')+(_o('ripple',__l.ripple).value?' bell-badge-ripple':'')+(_o('className',__l.className).value?' '+_w(_o('className',__l.className).value):'')},tag:'div',type:3},function(__i){_o('style',__l.style).value?_c(__i,'nativeProps',_o('style',__l.style).value,'style.cssText'):$0;},function(__j){_j('$slot_'+'children',__j);!_o('hidden',__l.hidden).value?(_o('dot',__l.dot).value?__j[__j.length]={context:_x,isPure:$2,isStatic:$2,nativeProps:$5,tag:'span',type:3}:__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2},_o('text',__l.text).value||_v(_u(_o('isNumeric',__l.isNumeric,$0,_y&&_y.isNumeric||_z.isNumeric).value,_x,[_o('count',__l.count).value])).value?__j[__j.length]={context:_x,nativeProps:{className:'bell-badge-text'+(_v(_u(_o('hasSlot',__l.hasSlot,$0,_y&&_y.hasSlot||_z.hasSlot).value,_x,['children'])).value?' bell-badge-text-append':'')},ref:'append',tag:'span',text:_w(_o('text',__l.text).value||_v(_u(_o('formatText',__l.formatText,$0,_y&&_y.formatText||_z.formatText).value,_x,[_o('count',__l.count).value,_o('max',__l.max).value])).value),type:3}:__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2}):__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2};});}})();
  ...
  var template$M = (function(){var $0=void 0,$2=!0,$5={className:'bell-card-media-title'},$6={className:'bell-card-media-sub-title'},$7={className:'bell-card-media-detail'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__l,__m,__j,__k){__j[__j.length]=_a({context:_x,nativeProps:{className:'bell-card-media'+(_o('className',__l.className).value?' '+_w(_o('className',__l.className).value):'')},tag:'div',type:3},function(__i){_o('style',__l.style).value?_c(__i,'nativeProps',_o('style',__l.style).value,'style.cssText'):$0;},function(__j){_j('$slot_'+'children',__j);_v(_u(_o('hasSlot',__l.hasSlot,$0,_y&&_y.hasSlot||_z.hasSlot).value,_x,['title'])).value||_v(_u(_o('hasSlot',__l.hasSlot,$0,_y&&_y.hasSlot||_z.hasSlot).value,_x,['subTitle'])).value?__j[__j.length]=_a({context:_x,nativeProps:$7,tag:'div',type:3},$0,function(__j){_v(_u(_o('hasSlot',__l.hasSlot,$0,_y&&_y.hasSlot||_z.hasSlot).value,_x,['title'])).value?__j[__j.length]=_a({context:_x,nativeProps:$5,tag:'div',type:3},$0,function(__j){_j('$slot_'+'title',__j);}):__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2};_v(_u(_o('hasSlot',__l.hasSlot,$0,_y&&_y.hasSlot||_z.hasSlot).value,_x,['subTitle'])).value?__j[__j.length]=_a({context:_x,nativeProps:$6,tag:'div',type:3},$0,function(__j){_j('$slot_'+'subTitle',__j);}):__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2};}):__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2};});}})();
  ...
  var template$17 = (function(){var $0=void 0,$2=!0,$5={className:'bell-description-title'},$6={className:'bell-description-extra'},$7={className:'bell-description-header'},$8={className:'bell-description-item-label'},$9={className:'bell-description-item-content'},$10={className:'bell-description-item-wrapper'},$11={className:'bell-description-row'},$12={className:'bell-description-table'},$13={className:'bell-description-cell bell-description-item-label'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__l,__m,__j,__k){__j[__j.length]=_a({context:_x,nativeProps:{className:'bell-description'+(_o('simple',__l.simple).value?' bell-description-simple':' bell-description-bordered'+(_o('size',__l.size).value?' bell-description-'+_w(_o('size',__l.size).value):''))+(_o('className',__l.className).value?' '+_w(_o('className',__l.className).value):'')},tag:'div',type:3},function(__i){_o('style',__l.style).value?_c(__i,'nativeProps',_o('style',__l.style).value,'style.cssText'):$0;},function(__j){_o('title',__l.title).value?__j[__j.length]=_a({context:_x,nativeProps:$7,tag:'div',type:3},$0,function(__j){__j[__j.length]={context:_x,nativeProps:$5,tag:'div',text:_w(_o('title',__l.title).value),type:3};_v(_u(_o('hasSlot',__l.hasSlot,$0,_y&&_y.hasSlot||_z.hasSlot).value,_x,['extra'])).value?__j[__j.length]=_a({context:_x,nativeProps:$6,tag:'div',type:3},$0,function(__j){_j('$slot_'+'extra',__j);}):__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2};}):__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2};_o('simple',__l.simple).value?__j[__j.length]=_a({context:_x,nativeProps:$12,tag:'table',type:3},$0,function(__j){_l(_o('cells',__l.cells),function(__l,__m,__n,rowIndex){__j[__j.length]=_a({context:_x,nativeProps:$11,tag:'tr',type:3},$0,function(__j){_l(_p(__l),function(__l,__m,__n,colIndex){__j[__j.length]=_a({context:_x,nativeProps:{className:'bell-description-cell'},tag:'td',type:3},function(__i){_r('span',__l.span).value>1?_c(__i,'nativeProps',_r('span',__l.span).value*2-1,'colSpan'):$0;},function(__j){__j[__j.length]=_a({context:_x,nativeProps:$10,tag:'div',type:3},$0,function(__j){__j[__j.length]={context:_x,nativeProps:$8,tag:'div',text:_w(_r('label',__l.label).value),type:3};__j[__j.length]=_a({context:_x,nativeProps:$9,tag:'div',type:3},$0,function(__j){_j('$slot_'+_r('name',__l.name).value,__j);});});});});});});}):__j[__j.length]=_a({context:_x,nativeProps:$12,tag:'table',type:3},$0,function(__j){_l(_o('cells',__l.cells),function(__l,__m,__n,rowIndex){__j[__j.length]=_a({context:_x,nativeProps:$11,tag:'tr',type:3},$0,function(__j){_l(_p(__l),function(__l,__m,__n,colIndex){__j[__j.length]={context:_x,nativeProps:$13,tag:'td',text:_w(_r('label',__l.label).value),type:3};__j[__j.length]=_a({context:_x,nativeProps:{className:'bell-description-cell bell-description-item-content'},tag:'td',type:3},function(__i){_r('span',__l.span).value>1?_c(__i,'nativeProps',_r('span',__l.span).value*2-1,'colSpan'):$0;},function(__j){_j('$slot_'+_r('name',__l.name).value,__j);});});});});});});}})();
  ...
  var template$1b = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__l,__m,__j,__k){__j[__j.length]=_a({context:_x,nativeProps:{className:'bell-form'+(_o('inline',__l.inline).value?' bell-form-inline':' bell-form-block')+(_o('showColon',__l.showColon).value?' bell-form-colon':'')+(_o('labelAlign',__l.labelAlign).value?' bell-form-label-'+_w(_o('labelAlign',__l.labelAlign).value):'')+(_o('className',__l.className).value?' '+_w(_o('className',__l.className).value):'')},tag:'div',type:3},function(__i){_o('style',__l.style).value?_c(__i,'nativeProps',_o('style',__l.style).value,'style.cssText'):$0;},function(__j){_j('$slot_'+'children',__j);});}})();
  ...
  var template$1c = (function(){var $0=void 0,$2=!0,$5={className:'bell-form-item-controls'},$6={className:'bell-form-item-extra'},$7={className:'bell-form-item-message'},$8={className:'bell-form-item-wrapper'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__l,__m,__j,__k){__j[__j.length]=_a({context:_x,nativeProps:{className:'bell-form-item'+(_o('extra',__l.extra).value?' bell-form-item-with-extra':'')+(_o('showItemMessage',__l.showItemMessage).value?' bell-form-item-with-message':'')+(_o('labelAlign',__l.labelAlign).value?' bell-form-item-align-'+_w(_o('labelAlign',__l.labelAlign).value):'')+(_o('className',__l.className).value?' '+_w(_o('className',__l.className).value):'')},tag:'div',type:3},function(__i){_o('style',__l.style).value?_c(__i,'nativeProps',_o('style',__l.style).value,'style.cssText'):$0;},function(__j){_o('label',__l.label).value||_v(_u(_o('hasSlot',__l.hasSlot,$0,_y&&_y.hasSlot||_z.hasSlot).value,_x,['label'])).value?(__j[__j.length]=_a({context:_x,nativeProps:{className:'bell-form-item-label'+(_o('showRequiredMark',__l.showRequiredMark).value?' bell-form-item-label-required':'')},tag:'label',type:3},function(__i){_o('itemLabelWidth',__l.itemLabelWidth).value?_c(__i,'nativeProps',_o('itemLabelWidth',__l.itemLabelWidth).value?'flex: 0 0 '+_w(_o('itemLabelWidth',__l.itemLabelWidth).value)+'px;':'','style.cssText'):$0;},function(__j){_j('$slot_'+'label',__j,function(){__j[__j.length]={isPure:$2,isText:$2,text:_w(_o('label',__l.label).value),type:1};});}),__j[__j.length]=_a({context:_x,nativeProps:$8,tag:'div',type:3},$0,function(__j){__j[__j.length]=_a({context:_x,nativeProps:$5,tag:'div',type:3},$0,function(__j){_j('$slot_'+'children',__j);});_o('extra',__l.extra).value?__j[__j.length]={context:_x,nativeProps:$6,tag:'div',text:_w(_o('extra',__l.extra).value),type:3}:__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2};_o('showItemMessage',__l.showItemMessage).value?__j[__j.length]={context:_x,nativeProps:$7,tag:'div',text:_w(_o('itemMessage',__l.itemMessage).value),type:3}:__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2};})):__j[__j.length]=_a({context:_x,nativeProps:{className:'bell-form-item-wrapper'},tag:'div',type:3},function(__i){_o('itemLabelWidth',__l.itemLabelWidth).value?_c(__i,'nativeProps','margin-left: '+_w(_o('itemLabelWidth',__l.itemLabelWidth).value)+'px;','style.cssText'):$0;},function(__j){_j('$slot_'+'children',__j);_o('extra',__l.extra).value?__j[__j.length]={context:_x,nativeProps:$6,tag:'div',text:_w(_o('extra',__l.extra).value),type:3}:__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2};_o('showItemMessage',__l.showItemMessage).value?__j[__j.length]={context:_x,nativeProps:$7,tag:'div',text:_w(_o('itemMessage',__l.itemMessage).value),type:3}:__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2};});});}})();
