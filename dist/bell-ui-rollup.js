...
(function (global, factory) {
  ...
  function template(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-menu'),_y({name:'mode',lookup:$3})?[_r(' bell-menu-'),_r(_7(_y({name:'mode',lookup:$3})))].join(''):_s(),!_y({name:'inner',lookup:$3})&&_y({name:'theme',lookup:$3})?[_r(' bell-menu-'),_r(_7(_y({name:'theme',lookup:$3})))].join(''):_s(),_y({name:'collapsed',lookup:$3})?_r(' bell-menu-collapsed'):_s(),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$3(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'i',nativeProps:{className:[_r('bell-icon'),_y({name:'name',lookup:$3})?[_r(' bell-icon-'),_r(_7(_y({name:'name',lookup:$3})))].join(''):_s(),_y({name:'spin',lookup:$3})?_r(' bell-icon-spin'):_s(),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'size',lookup:$3})>0||_y({name:'color',lookup:$3})||_y({name:'style',lookup:$3})?_d('style.cssText',[_y({name:'size',lookup:$3})>0?[_r('font-size: '),_r(_7(_y({name:'size',lookup:$3}))),_r('px;')].join(''):_s(),_y({name:'color',lookup:$3})?[_r('color: '),_r(_7(_y({name:'color',lookup:$3}))),_r(';')].join(''):_s(),_y({name:'style',lookup:$3})?_r(_7(_y({name:'style',lookup:$3}))):_s()].join('')):_s()],[_t('$slot_children')])}
  ...
  function template$6(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'span',nativeProps:{className:[_r('bell-text'),_y({name:'type',lookup:$3})?[_r(' bell-text-'),_r(_7(_y({name:'type',lookup:$3})))].join(''):_s(),_y({name:'size',lookup:$3})?[_r(' bell-text-'),_r(_7(_y({name:'size',lookup:$3})))].join(''):_s(),_y({name:'bold',lookup:$3})?_r(' bell-text-bold'):_s(),_y({name:'block',lookup:$3})?_r(' bell-text-block'):_s(),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$8(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-breadcrumb'),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$i(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-checkbox-group'),_y({name:'vertical',lookup:$3})?_r(' bell-checkbox-vertical'):_s(),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$n(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-dropdown-item'),_y({name:'disabled',lookup:$3})?_r(' bell-dropdown-item-disabled'):_r(' bell-dropdown-item-enabled'),_y({name:'isSelected',lookup:$3})?_r(' bell-dropdown-item-active'):_s(),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s(),!_y({name:'disabled',lookup:$3})?_k({key:'click',value:'clickOption()',from:'click',method:'clickOption'}):_s()],[_t('$slot_children',function(){return [_r(_7(_y({name:'text',lookup:$3})))]})])}
  ...
  function template$o(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-select-option-group'),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_a({tag:'div',text:_7(_y({name:'label',lookup:$3})),nativeProps:{className:'bell-select-group-title'}}),_t('$slot_children')])}
  ...
  function template$q(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $1=void 0,$3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-upload'),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')},events:{click:_l({key:'click',value:'click()',from:'click',method:'click'})}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children'),_a({tag:'form',ref:'form'},$1,[_a({tag:'input',ref:'input',nativeProps:{type:'file',multiple:_y({name:'multiple',lookup:$3}),accept:_y({name:'accept',lookup:$3})},events:{change:_l({key:'change',value:'changeFiles()',from:'change',method:'changeFiles'})}})])])}
  ...
  function template$t(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $1=void 0,$3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-spin'),_y({name:'type',lookup:$3})?[_r(' bell-spin-'),_r(_7(_y({name:'type',lookup:$3})))].join(''):_s(),_y({name:'size',lookup:$3})?[_r(' bell-spin-'),_r(_7(_y({name:'size',lookup:$3})))].join(''):_s(),_y({name:'theme',lookup:$3})?[_r(' bell-spin-'),_r(_7(_y({name:'theme',lookup:$3})))].join(''):_s(),_y({name:'fixed',lookup:$3})?_r(' bell-spin-fixed'):_s(),_y({name:'legacy',lookup:$3})?_r(' bell-spin-legacy'):_s(),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_a({tag:'div',ref:'content',nativeProps:{className:'bell-spin-content'}},$1,[_t('$slot_children',function(){return [_b({tag:'Icon',props:{spin:$3,name:_y({name:'icon',lookup:$3}),size:'0',className:'bell-spin-icon'},isComponent:$3}),_y({name:'text',lookup:$3})?_a({tag:'div',text:_7(_y({name:'text',lookup:$3})),nativeProps:{className:'bell-spin-text'}}):_s()]})])])}
  ...
  function template$w(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-badge'),_y({name:'status',lookup:$3})?_r('-status'):_s(),_y({name:'status',lookup:$3})?[_r(' bell-badge-status-'),_r(_7(_y({name:'status',lookup:$3})))].join(''):_y({name:'type',lookup:$3})?[_r(' bell-badge-'),_r(_7(_y({name:'type',lookup:$3})))].join(''):_s(),_y({name:'ripple',lookup:$3})?_r(' bell-badge-ripple'):_s(),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children'),!_y({name:'hidden',lookup:$3})?[_y({name:'dot',lookup:$3})?_a({tag:'span',nativeProps:{className:'bell-badge-dot'},isStatic:$3}):_s(),_y({name:'text',lookup:$3})||_1(_y({name:'isNumeric',call:$3,lookup:$3}),[_y({name:'count',lookup:$3})])?_a({tag:'span',ref:'append',text:_7(_y({name:'text',lookup:$3})||_1(_y({name:'formatText',call:$3,lookup:$3}),[_y({name:'count',lookup:$3}),_y({name:'max',lookup:$3})])),nativeProps:{className:[_r('bell-badge-text'),_1(_y({name:'hasSlot',call:$3,lookup:$3}),['children'])?_r(' bell-badge-text-append'):_s()].join('')}}):_s()]:_s()])}
  ...
  function template$E(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-collapse'),_y({name:'simple',lookup:$3})?_r(' bell-collapse-simple'):_r(' bell-collapse-bordered'),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$G(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-card bell-card-shadow-'),_r(_7(_y({name:'shadow',lookup:$3}))),_y({name:'simple',lookup:$3})?_r(' bell-card-simple'):_r(' bell-card-bordered'),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'width',lookup:$3})||_y({name:'style',lookup:$3})?_d('style.cssText',[_y({name:'width',lookup:$3})?[_r('width: '),_r(_7(_y({name:'width',lookup:$3}))),_r('px;')].join(''):_s(),_y({name:'style',lookup:$3})?_r(_7(_y({name:'style',lookup:$3}))):_s()].join('')):_s()],[_t('$slot_children')])}
  ...
  function template$J(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-card-body'),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$K(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-card-footer'),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$M(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-layout'),_y({name:'vertical',lookup:$3})?_r(' bell-layout-vertical'):_r(' bell-layout-horizontal'),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$N(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $1=void 0,$3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-layout-header'),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_1(_y({name:'hasSlot',call:$3,lookup:$3}),['extra'])?_a({tag:'div',nativeProps:{className:'bell-layout-header-extra'}},$1,[_t('$slot_extra')]):_s(),_t('$slot_children')])}
  ...
  function template$O(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-layout-content'),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$P(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-layout-footer'),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$S(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $1=void 0,$3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-list'),_y({name:'size',lookup:$3})?[_r(' bell-list-'),_r(_7(_y({name:'size',lookup:$3})))].join(''):_s(),_y({name:'simple',lookup:$3})?_r(' bell-list-simple'):_r(' bell-list-bordered'),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_u('empty',function(_2){return [_a({tag:'div',nativeProps:{className:'bell-list-empty'}},$1,[_t('$slot_empty',function(){return [_b({tag:'Empty',isComponent:$3},$1,{$slot_children:[_r('暂无数据')]})]})])]}),_1(_y({name:'hasSlot',call:$3,lookup:$3}),['header'])?[_a({tag:'div',nativeProps:{className:'bell-list-header'}},$1,[_t('$slot_header')]),_a({tag:'div',nativeProps:{className:'bell-list-body'}},$1,[_t('$slot_children',function(){return [_v('empty')]})])]:_t('$slot_children',function(){return [_v('empty')]}),_y({name:'loading',lookup:$3})?_b({tag:'Spin',props:{size:'large',fixed:$3},isComponent:$3}):_s()])}

  function template$T(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-empty'),_y({name:'simple',lookup:$3})?_r(' bell-empty-simple'):_s(),_1(_y({name:'hasSlot',call:$3,lookup:$3}),['children'])?_r(' bell-empty-with-content'):_s(),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$U(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-list-item'),_y({name:'clickable',lookup:$3})?_r(' bell-list-item-clickable'):_s(),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s(),_y({name:'clickable',lookup:$3})?_m({key:'click',value:'click.listItem',from:'click',to:'click',toNs:'listItem'}):_s()],[_t('$slot_children')])}
  ...
  function template$W(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $1=void 0,$3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-exception'),_y({name:'status',lookup:$3})?[_r(' bell-exception-'),_r(_7(_y({name:'status',lookup:$3})))].join(''):_s(),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_y({name:'title',lookup:$3})?_a({tag:'div',text:_7(_y({name:'title',lookup:$3})),nativeProps:{className:'bell-exception-title'}}):_s(),_y({name:'subTitle',lookup:$3})?_a({tag:'div',text:_7(_y({name:'subTitle',lookup:$3})),nativeProps:{className:'bell-exception-sub-title'}}):_s(),_1(_y({name:'hasSlot',call:$3,lookup:$3}),['extra'])?_a({tag:'div',nativeProps:{className:'bell-exception-extra'}},$1,[_t('$slot_extra')]):_s()])}
  ...
  function template$10(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-tabs-panel'),_y({name:'isActive',lookup:$3})?_r(' bell-tabs-panel-active'):_s(),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$11(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-dropdown-item'),_y({name:'divided',lookup:$3})?_r(' bell-dropdown-item-divided'):_s(),_y({name:'active',lookup:$3})?_r(' bell-dropdown-item-active'):_s(),_y({name:'disabled',lookup:$3})?_r(' bell-dropdown-item-disabled'):_r(' bell-dropdown-item-enabled'),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s(),!_y({name:'disabled',lookup:$3})?_m({key:'click',value:'click.dropdownItem',from:'click',to:'click',toNs:'dropdownItem'}):_s()],[_t('$slot_children')])}
  ...
  function template$12(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-dropdown-menu'),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$14(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-timeline'),_y({name:'pending',lookup:$3})?_r(' bell-timeline-pending'):_s(),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$16(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-form'),_y({name:'inline',lookup:$3})?_r(' bell-form-inline'):_s(),_y({name:'showColon',lookup:$3})?_r(' bell-form-colon'):_s(),_y({name:'labelAlign',lookup:$3})?[_r(' bell-form-label-'),_r(_7(_y({name:'labelAlign',lookup:$3})))].join(''):_s(),_y({name:'className',lookup:$3})?[_r(' '),_r(_7(_y({name:'className',lookup:$3})))].join(''):_s()].join('')}},[_y({name:'style',lookup:$3})?_d('style.cssText',_y({name:'style',lookup:$3})):_s()],[_t('$slot_children')])}
  ...
  function template$1a(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_7){var $1=void 0,$3=!0;return _a({tag:'div',nativeProps:{className:[_r('bell-loadingbar'),_y({name:'type',lookup:$3})?[_r(' bell-loadingbar-'),_r(_7(_y({name:'type',lookup:$3})))].join(''):_s()].join('')}},$1,[_a({tag:'div',nativeProps:{className:'bell-loadingbar-indicator','style.cssText':[_r('width: '),_r(_7(_y({name:'percent',lookup:$3}))),_r('%;height: '),_r(_7(_y({name:'height',lookup:$3}))),_r('px;'),_y({name:'color',lookup:$3})?[_r('color: '),_r(_7(_y({name:'color',lookup:$3}))),_r(';')].join(''):_s()].join('')}})])}
