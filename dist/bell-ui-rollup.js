...
(function (global, factory) {
  ...
  var template$D = (function(){var $0=void 0,$2=!0,$4=function(__h){return __h.length-1},$5=function(){return 0},$6={className:'bell-timepicker-panel-column'},$7={className:'bell-timepicker-panel-columns'},$8={className:'bell-timepicker-panel-footer'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__l,__m,__j,__k){__j[__j.length]=_a({context:_x,nativeProps:{className:'bell-timepicker-panel'+(_o('className',__l.className).value?' '+_w(_o('className',__l.className).value):'')},tag:'div',type:3},function(__i){_o('style',__l.style).value?_c(__i,'nativeProps',_o('style',__l.style).value,'style.cssText'):$0;},function(__j){__j[__j.length]=_a({context:_x,nativeProps:$7,tag:'div',type:3},$0,function(__j){__j[__j.length]=_a({context:_x,nativeProps:$6,ref:'hourList',tag:'ul',type:3},$0,function(__j){_l(_o('hourList',__l.hourList),function(__l,__m,__n,index){__j[__j.length]={context:_x,events:{click:_f('click','handleHourClick(index)','click','',_x.handleHourClick,{args:function(__h,__o,__p){return [index]}})},key:_p(__l).value,nativeProps:{className:'bell-timepicker-panel-row'+(index===_s($5,'hourIndex').value?' bell-timepicker-panel-row-active':'')},tag:'li',text:_w(_v(_u(_o('leftPad',__l.leftPad,$0,_y&&_y.leftPad||_z.leftPad).value,_x,[_p(__l).value])).value),type:3};});});__j[__j.length]=_a({context:_x,nativeProps:$6,ref:'minuteList',tag:'ul',type:3},$0,function(__j){_l(_o('minuteList',__l.minuteList),function(__l,__m,__n,index){__j[__j.length]={context:_x,events:{click:_f('click','handleMinuteClick(index)','click','',_x.handleMinuteClick,{args:function(__h,__o,__p){return [index]}})},key:_p(__l).value,nativeProps:{className:'bell-timepicker-panel-row'+(index===_s($5,'minuteIndex').value?' bell-timepicker-panel-row-active':'')},tag:'li',text:_w(_v(_u(_o('leftPad',__l.leftPad,$0,_y&&_y.leftPad||_z.leftPad).value,_x,[_p(__l).value])).value),type:3};});});_n($4,'secondList.length',$2).value>0?__j[__j.length]=_a({context:_x,nativeProps:$6,ref:'secondList',tag:'ul',type:3},$0,function(__j){_l(_o('secondList',__l.secondList),function(__l,__m,__n,index){__j[__j.length]={context:_x,events:{click:_f('click','handleSecondClick(index)','click','',_x.handleSecondClick,{args:function(__h,__o,__p){return [index]}})},key:_p(__l).value,nativeProps:{className:'bell-timepicker-panel-row'+(index===_s($5,'secondIndex').value?' bell-timepicker-panel-row-active':'')},tag:'li',text:_w(_v(_u(_o('leftPad',__l.leftPad,$0,_y&&_y.leftPad||_z.leftPad).value,_x,[_p(__l).value])).value),type:3};});}):__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2};});__j[__j.length]=_a({context:_x,nativeProps:$8,tag:'div',type:3},$0,function(__j){__j[__j.length]=__k[__k.length]=_b({context:_x,events:{click:_f('click','handleSubmitClick()','click','',_x.handleSubmitClick,$0,$2)},isComponent:$2,props:{disabled:!_o('hasValue',__l.hasValue).value,size:'small',type:'primary'},tag:'Button',type:4},$0,{$slot_children:function(__j,__k){__j[__j.length]={isPure:$2,isText:$2,text:'确定',type:1};}});});});}})();
  ...
  function formatTime(hour, minute, second) {
      var list = [];
      if (hour >= 0) {
          list.push(leftPad(hour));
      }
      if (minute >= 0) {
          list.push(leftPad(minute));
      }
      if (second >= 0) {
          list.push(leftPad(second));
      }
      return list.join(':');
  }
  ...
  var template$E = (function(){var $0=void 0,$2=!0,$5={className:'bell-timepicker-value'},$6={className:'bell-timepicker-placeholder'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__l,__m,__j,__k){__j[__j.length]=__k[__k.length]=_b({context:_x,events:{outside:_f('outside','handleOutsideClick()','outside','',_x.handleOutsideClick,$0,$2)},isComponent:$2,props:{className:'bell-timepicker'+(_o('status',__l.status).value?' bell-timepicker-'+_w(_o('status',__l.status).value):'')+(_o('size',__l.size).value?' bell-timepicker-'+_w(_o('size',__l.size).value):'')+(_o('block',__l.block).value?' bell-timepicker-block':'')+(_o('disabled',__l.disabled).value?' bell-timepicker-disabled':' bell-timepicker-enabled')+(_o('clearable',__l.clearable).value?' bell-timepicker-clearable':'')+(_o('className',__l.className).value?' '+_w(_o('className',__l.className).value):''),placement:_o('placement',__l.placement).value,style:(_o('componentWidth',__l.componentWidth).value?'width: '+_w(_o('componentWidth',__l.componentWidth).value)+'px;':'')+(_o('style',__l.style).value?_w(_o('style',__l.style).value):''),trigger:'custom',visible:_o('visible',__l.visible).value},tag:'Dropdown',type:4},$0,{$slot_children:function(__j,__k){__j[__j.length]=_a({context:_x,nativeProps:{className:'bell-timepicker-button'},tag:'div',type:3},function(__i){!_o('disabled',__l.disabled).value?_c(__i,'events',_f('click',"toggle('visible')",'click','',_x.toggle,{args:function(__h,__o,__p){return ['visible']}}),'click'):$0;},function(__j){_o('text',__l.text).value?__j[__j.length]={context:_x,nativeProps:$5,tag:'div',text:_w(_o('text',__l.text).value),type:3}:__j[__j.length]={context:_x,nativeProps:$6,tag:'div',text:_w(_o('placeholder',__l.placeholder).value),type:3};_o('clearable',__l.clearable).value&&_o('hasValue',__l.hasValue).value?__j[__j.length]=__k[__k.length]={context:_x,events:{'click.native':_f('click.native','handleClearClick()','click','native',_x.handleClearClick,$0,$0,$2)},isComponent:$2,props:{className:'bell-timepicker-clear-icon',name:'close-circle-fill',size:'0'},tag:'Icon',type:4}:__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2};__j[__j.length]=__k[__k.length]={context:_x,isComponent:$2,props:{className:'bell-timepicker-time-icon',name:'time-line',size:'0'},tag:'Icon',type:4};});},$slot_overlay:function(__j,__k){__j[__j.length]=__k[__k.length]={context:_x,isComponent:$2,props:{hourIndex:_o('visible',__l.visible).value?_o('hourIndex',__l.hourIndex).value:-1,hourList:_o('hourList',__l.hourList).value,minuteIndex:_o('visible',__l.visible).value?_o('minuteIndex',__l.minuteIndex).value:-1,minuteList:_o('minuteList',__l.minuteList).value,secondIndex:_o('visible',__l.visible).value?_o('secondIndex',__l.secondIndex).value:-1,secondList:_o('secondList',__l.secondList).value},tag:'TimePanel',type:4};}});}})();
