...
(function (global, factory) {
  ...
  var template$1 = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-menu-item'+(_q('isActive',__n.isActive).value?' bell-menu-item-active':'')+(_q('disabled',__n.disabled).value?' bell-menu-item-disabled':' bell-menu-item-enabled')+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;!_q('disabled',__n.disabled).value?_c(__k,'events',_h('click','click()','click','',_z.click),'click'):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$2 = (function(){var $0=void 0,$2=!0,$5={className:'bell-menu-group-title'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-menu-group'+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){__l[__l.length]={context:_z,nativeProps:$5,tag:'div',text:_y(_q('title',__n.title).value),type:3};_x(_w(_q('hasSlot',__n.hasSlot,$0,__a&&__a.hasSlot||__b.hasSlot).value,_z,['children'])).value?__l[__l.length]=__m[__m.length]=_b({context:_z,isComponent:$2,props:{inner:$2,mode:_q('mode',__n.mode).value==='inline'?'inline':'vertical'},tag:'Menu',type:4},$0,{$slot_children:function(__l,__m){_l('$slot_'+'children',__l);}}):__l[__l.length]={isComment:$2,isPure:$2,text:'',type:2};});}})();
  ...
  var template$3 = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-icon'+(_q('name',__n.name).value?' bell-icon-'+_y(_q('name',__n.name).value):'')+(_q('spin',__n.spin).value?' bell-icon-spin':'')+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'i',type:3},function(__k){_q('size',__n.size).value>0||_q('color',__n.color).value||_q('style',__n.style).value?__k.nativeStyles=_d((_q('size',__n.size).value>0?'font-size: '+_y(_q('size',__n.size).value)+'px;':'')+(_q('color',__n.color).value?'color: '+_y(_q('color',__n.color).value)+';':'')+(_q('style',__n.style).value?_y(_q('style',__n.style).value):'')):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$4 = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-dropdown bell-dropdown-'+_y(_q('placement',__n.placement).value)+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-dropdown-trigger'},tag:'div',type:3},function(__k){_q('trigger',__n.trigger).value===_q('RAW_CLICK',__n.RAW_CLICK).value?_c(__k,'events',_h('click','toggleVisible()','click','',_z.toggleVisible),'click'):_q('trigger',__n.trigger).value===_q('RAW_HOVER',__n.RAW_HOVER).value?(_c(__k,'events',_h('mouseenter','enter()','mouseenter','',_z.enter),'mouseenter'),_c(__k,'events',_h('mouseleave','leave()','mouseleave','',_z.leave),'mouseleave')):$0;},function(__l){_l('$slot_'+'children',__l);});__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-dropdown-overlay'},ref:'overlay',tag:'div',type:3},function(__k){_q('height',__n.height).value>0?__k.nativeStyles=_d('max-height: '+_y(_q('height',__n.height).value)+'px;'):$0;_q('trigger',__n.trigger).value===_q('RAW_HOVER',__n.RAW_HOVER).value?(_c(__k,'events',_h('mouseenter','enter()','mouseenter','',_z.enter),'mouseenter'),_c(__k,'events',_h('mouseleave','leave()','mouseleave','',_z.leave),'mouseleave')):$0;},function(__l){_l('$slot_'+'overlay',__l);});});}})();
  ...
  var template$6 = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-text'+(_q('type',__n.type).value?' bell-text-'+_y(_q('type',__n.type).value):'')+(_q('size',__n.size).value?' bell-text-'+_y(_q('size',__n.size).value):'')+(_q('bold',__n.bold).value?' bell-text-bold':'')+(_q('block',__n.block).value?' bell-text-block':'')+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'span',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$8 = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-breadcrumb'+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$9 = (function(){var $0=void 0,$2=!0,$5={className:'bell-breadcrumb-separator'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-breadcrumb-item'+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'span',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){__l[__l.length]=_a({context:_z,tag:'span',type:3},function(__k){_q('last',__n.last).value?_c(__k,'nativeProps','bell-breadcrumb-text','className'):(_c(__k,'nativeProps','bell-breadcrumb-link','className'),_c(__k,'events',_i('click','click.breadcrumbItem','click','','click','breadcrumbItem'),'click'));},function(__l){_l('$slot_'+'children',__l);});!_q('last',__n.last).value?__l[__l.length]={context:_z,nativeProps:$5,tag:'span',text:_y(_q('separator',__n.separator).value),type:3}:__l[__l.length]={isComment:$2,isPure:$2,text:'',type:2};});}})();
  ...
  var template$i = (function(){var $0=void 0,$2=!0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=__m[__m.length]=_b({context:_z,isComponent:$2,props:{className:'bell-checkbox-group'+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'Space',type:4},function(__k){_q('vertical',__n.vertical).value?(_c(__k,'props',$2,'vertical'),_c(__k,'props','start','align'),_c(__k,'props',_q('CHECKBOX_GAP_VERTICAL',__n.CHECKBOX_GAP_VERTICAL).value,'size')):(_c(__k,'props',$2,'autoWrap'),_c(__k,'props','center','align'),_c(__k,'props',[_q('CHECKBOX_GAP_HORIZONTAL',__n.CHECKBOX_GAP_HORIZONTAL).value,_q('CHECKBOX_GAP_VERTICAL',__n.CHECKBOX_GAP_VERTICAL).value],'size'));_q('style',__n.style).value?_c(__k,'props',_q('style',__n.style).value,'style'):$0;},{$slot_children:function(__l,__m){_l('$slot_'+'children',__l);}});}})();

  var template$j = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-space'+(_q('vertical',__n.vertical).value?' bell-space-vertical':' bell-space-horizontal')+(_q('align',__n.align).value?' bell-space-align-'+_y(_q('align',__n.align).value):'')+(_q('autoWrap',__n.autoWrap).value?' bell-space-auto-wrap':'')+(_q('block',__n.block).value?' bell-space-block':'')+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('sizeValue',__n.sizeValue).value||_q('style',__n.style).value?__k.nativeStyles=_d((_q('sizeValue',__n.sizeValue).value?'gap: '+_y(_q('sizeValue',__n.sizeValue).value)+';':'')+(_q('style',__n.style).value?_y(_q('style',__n.style).value):'')):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$p = (function(){var $0=void 0,$5={className:'bell-select-group-title'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-select-option-group'+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){__l[__l.length]={context:_z,nativeProps:$5,tag:'div',text:_y(_q('label',__n.label).value),type:3};_l('$slot_'+'children',__l);});}})();
  ...
  var template$r = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,events:{click:_h('click','click()','click','',_z.click)},nativeProps:{className:'bell-upload'+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);__l[__l.length]=_a({context:_z,ref:'form',tag:'form',type:3},$0,function(__l){__l[__l.length]={context:_z,events:{change:_h('change','onChange()','change','',_z.onChange)},nativeProps:{accept:_q('accept',__n.accept).value,multiple:_q('multiple',__n.multiple).value,type:'file'},ref:'input',tag:'input',type:3};});});}})();
  ...
  var template$u = (function(){var $0=void 0,$2=!0,$5={className:'bell-spin-text'},$6={className:'bell-spin-content'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-spin'+(_q('type',__n.type).value?' bell-spin-'+_y(_q('type',__n.type).value):'')+(_q('size',__n.size).value?' bell-spin-'+_y(_q('size',__n.size).value):'')+(_q('theme',__n.theme).value?' bell-spin-'+_y(_q('theme',__n.theme).value):'')+(_q('fixed',__n.fixed).value?' bell-spin-fixed':'')+(_q('legacy',__n.legacy).value?' bell-spin-legacy':'')+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){__l[__l.length]=_a({context:_z,nativeProps:$6,ref:'content',tag:'div',type:3},$0,function(__l){_l('$slot_'+'children',__l,function(){__l[__l.length]=__m[__m.length]={context:_z,isComponent:$2,props:{className:'bell-spin-icon',name:_q('icon',__n.icon).value,size:'0',spin:$2},tag:'Icon',type:4};_q('text',__n.text).value?__l[__l.length]={context:_z,nativeProps:$5,tag:'div',text:_y(_q('text',__n.text).value),type:3}:__l[__l.length]={isComment:$2,isPure:$2,text:'',type:2};});});});}})();
  ...
  var template$I = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-collapse'+(_q('simple',__n.simple).value?' bell-collapse-simple':' bell-collapse-bordered')+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$K = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-card bell-card-shadow-'+_y(_q('shadow',__n.shadow).value)+(_q('simple',__n.simple).value?' bell-card-simple':' bell-card-bordered')+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('width',__n.width).value||_q('style',__n.style).value?__k.nativeStyles=_d((_q('width',__n.width).value?'width: '+_y(_q('width',__n.width).value)+'px;':'')+(_q('style',__n.style).value?_y(_q('style',__n.style).value):'')):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$M = (function(){var $0=void 0,$2=!0,$5={className:'bell-card-media-title'},$6={className:'bell-card-media-sub-title'},$7={className:'bell-card-media-detail'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-card-media'+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);_x(_w(_q('hasSlot',__n.hasSlot,$0,__a&&__a.hasSlot||__b.hasSlot).value,_z,['title'])).value||_x(_w(_q('hasSlot',__n.hasSlot,$0,__a&&__a.hasSlot||__b.hasSlot).value,_z,['subTitle'])).value?__l[__l.length]=_a({context:_z,nativeProps:$7,tag:'div',type:3},$0,function(__l){_x(_w(_q('hasSlot',__n.hasSlot,$0,__a&&__a.hasSlot||__b.hasSlot).value,_z,['title'])).value?__l[__l.length]=_a({context:_z,nativeProps:$5,tag:'div',type:3},$0,function(__l){_l('$slot_'+'title',__l);}):__l[__l.length]={isComment:$2,isPure:$2,text:'',type:2};_x(_w(_q('hasSlot',__n.hasSlot,$0,__a&&__a.hasSlot||__b.hasSlot).value,_z,['subTitle'])).value?__l[__l.length]=_a({context:_z,nativeProps:$6,tag:'div',type:3},$0,function(__l){_l('$slot_'+'subTitle',__l);}):__l[__l.length]={isComment:$2,isPure:$2,text:'',type:2};}):__l[__l.length]={isComment:$2,isPure:$2,text:'',type:2};});}})();
  ...
  var template$N = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-card-body'+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$O = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-card-footer'+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$Q = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-layout'+(_q('vertical',__n.vertical).value?' bell-layout-vertical':' bell-layout-horizontal')+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$R = (function(){var $0=void 0,$2=!0,$5={className:'bell-layout-header-extra'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-layout-header'+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_x(_w(_q('hasSlot',__n.hasSlot,$0,__a&&__a.hasSlot||__b.hasSlot).value,_z,['extra'])).value?__l[__l.length]=_a({context:_z,nativeProps:$5,tag:'div',type:3},$0,function(__l){_l('$slot_'+'extra',__l);}):__l[__l.length]={isComment:$2,isPure:$2,text:'',type:2};_l('$slot_'+'children',__l);});}})();
  ...
  var template$S = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-layout-content'+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$T = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-layout-footer'+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$X = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-empty'+(_q('simple',__n.simple).value?' bell-empty-simple':'')+(_x(_w(_q('hasSlot',__n.hasSlot,$0,__a&&__a.hasSlot||__b.hasSlot).value,_z,['children'])).value?' bell-empty-with-content':'')+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$Y = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-list-item'+(_q('clickable',__n.clickable).value?' bell-list-item-clickable':'')+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;_q('clickable',__n.clickable).value?_c(__k,'events',_i('click','click.listItem','click','','click','listItem'),'click'):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$_ = (function(){var $0=void 0,$2=!0,$5={className:'bell-exception-title'},$6={className:'bell-exception-sub-title'},$7={className:'bell-exception-extra'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-exception'+(_q('status',__n.status).value?' bell-exception-'+_y(_q('status',__n.status).value):'')+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_q('title',__n.title).value?__l[__l.length]={context:_z,nativeProps:$5,tag:'div',text:_y(_q('title',__n.title).value),type:3}:__l[__l.length]={isComment:$2,isPure:$2,text:'',type:2};_q('subTitle',__n.subTitle).value?__l[__l.length]={context:_z,nativeProps:$6,tag:'div',text:_y(_q('subTitle',__n.subTitle).value),type:3}:__l[__l.length]={isComment:$2,isPure:$2,text:'',type:2};_x(_w(_q('hasSlot',__n.hasSlot,$0,__a&&__a.hasSlot||__b.hasSlot).value,_z,['extra'])).value?__l[__l.length]=_a({context:_z,nativeProps:$7,tag:'div',type:3},$0,function(__l){_l('$slot_'+'extra',__l);}):__l[__l.length]={isComment:$2,isPure:$2,text:'',type:2};});}})();
  ...
  var template$14 = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-tabs-panel'+(_q('isActive',__n.isActive).value?' bell-tabs-panel-active':'')+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$16 = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-dropdown-menu'+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$19 = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-timeline'+(_q('pending',__n.pending).value?' bell-timeline-pending':'')+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$1b = (function(){var $0=void 0;return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-form'+(_q('inline',__n.inline).value?' bell-form-inline':' bell-form-block')+(_q('showColon',__n.showColon).value?' bell-form-colon':'')+(_q('labelAlign',__n.labelAlign).value?' bell-form-label-'+_y(_q('labelAlign',__n.labelAlign).value):'')+(_q('className',__n.className).value?' '+_y(_q('className',__n.className).value):'')},tag:'div',type:3},function(__k){_q('style',__n.style).value?__k.nativeStyles=_e(_q('style',__n.style).value):$0;},function(__l){_l('$slot_'+'children',__l);});}})();
  ...
  var template$1j = (function(){var $0=void 0,$2=!0,$5={className:'bell-notification-title'},$6={className:'bell-notification-content'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__h,__i,__n,__o,__l,__m){__l[__l.length]=_a({context:_z,nativeProps:{className:'bell-notification'+(_q('status',__n.status).value?' bell-notification-'+_y(_q('status',__n.status).value)+' bell-notification-with-icon':'')+(_q('title',__n.title).value?' bell-notification-with-title':'')+(_q('duration',__n.duration).value==0?' bell-notification-with-close':'')},nativeStyles:_d('width: '+_y(_q('width',__n.width).value)+'px;right: '+_y(_q('right',__n.right).value)+'px;'),tag:'div',type:3},$0,function(__l){_q('status',__n.status).value?__l[__l.length]=__m[__m.length]={context:_z,isComponent:$2,props:{className:'bell-notification-icon',name:_q('status',__n.status).value===_q('RAW_TYPE_SUCCESS',__n.RAW_TYPE_SUCCESS).value?'checkbox-circle-fill':_q('status',__n.status).value===_q('RAW_TYPE_WARNING',__n.RAW_TYPE_WARNING).value?'error-warning-fill':_q('status',__n.status).value===_q('RAW_TYPE_ERROR',__n.RAW_TYPE_ERROR).value?'close-circle-fill':'information-fill',size:'0'},tag:'Icon',type:4}:__l[__l.length]={isComment:$2,isPure:$2,text:'',type:2};_q('title',__n.title).value?__l[__l.length]={context:_z,nativeProps:$5,tag:'div',text:_y(_q('title',__n.title).value),type:3}:__l[__l.length]={isComment:$2,isPure:$2,text:'',type:2};_q('content',__n.content).value?__l[__l.length]={context:_z,nativeProps:$6,tag:'div',text:_y(_q('content',__n.content).value),type:3}:__l[__l.length]={isComment:$2,isPure:$2,text:'',type:2};_q('duration',__n.duration).value==0?__l[__l.length]=__m[__m.length]={context:_z,events:{'click.native':_h('click.native','hide()','click','native',_z.hide,$0,$0,$2)},isComponent:$2,props:{className:'bell-notification-close',name:'close-line',size:'0'},tag:'Icon',type:4}:__l[__l.length]={isComment:$2,isPure:$2,text:'',type:2};});}})();
