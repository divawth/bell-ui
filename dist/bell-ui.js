...
module.exports = function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,_1,_2,_8,_5,_6){var $1=void 0,$2=null,$3=!0,$4=!1,_v0=function(_3){return _3.length-1};_5[_5.length]=_b({context:_a,tag:'div',nativeProps:{className:['bell-notification',_p(_v0,['status'],$3).value?[' bell-notification-',_p(_v0,['status'],$3).value,' bell-notification-with-icon'].join(''):$1,_p(_v0,['title'],$3).value?' bell-notification-with-title':$1,_p(_v0,['duration'],$3).value==0?' bell-notification-with-close':$1].join(''),'style.cssText':['width: ',_p(_v0,['width'],$3).value,'px;right: ',_p(_v0,['right'],$3).value,'px;'].join('')}},$1,function(_5){_p(_v0,['status'],$3).value?_5[_5.length]=_6[_6.length]=_c({context:_a,tag:'Icon',props:{name:_p(_v0,['status'],$3).value===_p(_v0,['RAW_TYPE_SUCCESS'],$3).value?'checkbox-circle-fill':_p(_v0,['status'],$3).value===_p(_v0,['RAW_TYPE_WARNING'],$3).value?'error-warning-fill':_p(_v0,['status'],$3).value===_p(_v0,['RAW_TYPE_ERROR'],$3).value?'close-circle-fill':'information-fill',size:'0',className:'bell-notification-icon'},isComponent:$3}):_5[_5.length]={context:_a,isComment:$3,text:''};_p(_v0,['title'],$3).value?_5[_5.length]=_b({context:_a,tag:'div',text:_s(_p(_v0,['title'],$3).value),nativeProps:{className:'bell-notification-title'}}):_5[_5.length]={context:_a,isComment:$3,text:''};_p(_v0,['content'],$3).value?_5[_5.length]=_b({context:_a,tag:'div',text:_s(_p(_v0,['content'],$3).value),nativeProps:{className:'bell-notification-content'}}):_5[_5.length]={context:_a,isComment:$3,text:''};_p(_v0,['duration'],$3).value==0?_5[_5.length]=_6[_6.length]=_c({context:_a,tag:'Icon',props:{name:'close-line',size:'0',className:'bell-notification-close'},events:{'click.native':_h('click.native','hide()','click','native','hide',$1,$1,$3)},isComponent:$3}):_5[_5.length]={context:_a,isComment:$3,text:''}})};
