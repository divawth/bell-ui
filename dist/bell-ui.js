...
module.exports = (function(){var $0=void 0,$1=null,$2=!0,$3=!1,$4=function(__h){return __h.length-1},$5={className:'bell-image-picker-mask'},$6={className:'bell-image-picker-image-size'},$7={className:'bell-image-picker-item bell-image-picker-card'},$8={className:'bell-image-picker-wrapper'},$9={className:'bell-image-picker-extra'};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__l,__m,__j,__k){__j[__j.length]=_a({context:_x,nativeProps:{className:'bell-image-picker'+(_o('className',__l.className).value?' '+_w(_o('className',__l.className).value):'')},tag:'div',type:3},function(__i){_o('style',__l.style).value?_c(__i,'nativeProps',_o('style',__l.style).value,'style.cssText'):$0},function(__j){__j[__j.length]=_a({context:_x,nativeProps:$8,tag:'div',type:3},$0,function(__j){_l(_o('imageList',__l.imageList),function(__l,__m,__n,index){__j[__j.length]=_a({context:_x,nativeProps:$7,tag:'div',type:3},$0,function(__j){_r('url',__l.url).value||_r('base64',__l.base64).value?__j[__j.length]=_a({context:_x,nativeAttrs:{ondragstart:'return false'},nativeProps:{className:'bell-image-picker-image'},tag:'img',type:3},function(__i){_r('url',__l.url).value?_c(__i,'nativeProps',_r('url',__l.url).value,'src'):_r('base64',__l.base64).value?_c(__i,'nativeProps',_r('base64',__l.base64).value,'src'):$0;_r('name',__l.name).value?_c(__i,'nativeProps',_r('name',__l.name).value,'alt'):$0}):__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2};_r('status',__l.status).value===_o('STATUS_UPLOADING',__l.STATUS_UPLOADING).value?__j[__j.length]=_a({context:_x,nativeProps:$5,tag:'div',type:3},$0,function(__j){__j[__j.length]=__k[__k.length]=_b({context:_x,isComponent:$2,props:{percent:_r('progress',__l.progress).value*100,size:'60'},tag:'Circle',type:4},$0,{$slot_children:function(__j,__k){__j[__j.length]={isPure:$2,isText:$2,text:'上传中',type:1}}})}):(_r('status',__l.status).value===_o('STATUS_ERROR',__l.STATUS_ERROR).value?__j[__j.length]=_a({context:_x,nativeProps:$5,tag:'div',type:3},$0,function(__j){__j[__j.length]=__k[__k.length]=_b({context:_x,isComponent:$2,props:{percent:_r('progress',__l.progress).value*100,size:'60',strokeColor:'#ff5500'},tag:'Circle',type:4},$0,{$slot_children:function(__j,__k){__j[__j.length]=__k[__k.length]={context:_x,isComponent:$2,props:{name:'close-line',size:'30',style:'color:#ff5500'},tag:'Icon',type:4}}})}):_r('size',__l.size).value>0?__j[__j.length]={context:_x,nativeProps:$6,tag:'div',text:_w(_v(_u(_o('formatImageSize',__l.formatImageSize,$0,_y&&_y.formatImageSize||_z.formatImageSize).value,_x,[_r('size',__l.size).value])).value),type:3}:__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2},__j[__j.length]=__k[__k.length]={context:_x,events:{'click.native':_f('click.native','removeItem(index)','click','native',_x.removeItem,{args:function(__h,__o,__p){return [index]}},$0,$2)},isComponent:$2,props:{className:'bell-image-picker-remove-icon',name:'close-circle-fill'},tag:'Icon',type:4})})});_n($4,'imageList.length',$2).value<_o('maxCount',__l.maxCount).value?__j[__j.length]=__k[__k.length]=_b({context:_x,isComponent:$2,props:{accept:_o('accept',__l.accept).value,beforeUpload:_o('beforeUploadImage',__l.beforeUploadImage).value,className:'bell-image-picker-item bell-image-picker-append',multiple:_o('restCount',__l.restCount).value>1},ref:'upload',tag:'Upload',type:4},$0,{$slot_children:function(__j,__k){__j[__j.length]=__k[__k.length]={context:_x,isComponent:$2,props:{className:'bell-image-picker-append-icon',name:'add-line'},tag:'Icon',type:4}}}):__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2}});_o('extra',__l.extra).value?__j[__j.length]={context:_x,nativeProps:$9,tag:'div',text:_w(_o('extra',__l.extra).value),type:3}:__j[__j.length]={isComment:$2,isPure:$2,text:'',type:2}})}})();
