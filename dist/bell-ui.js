...
/* harmony default export */ var image_picker_ImagePicker = (external_root_Yox_commonjs_yox_commonjs2_yox_amd_yox_default.a.define({
    ...
    methods: {
        ...
        addDraggingItemClass: function (index) {
            ...
            if (targetChild) {
                external_root_Yox_commonjs_yox_commonjs2_yox_amd_yox_default.a.dom.addClass(targetChild, 'bell-drag-enter-active');
            }
        },
        removeDraggingItemClass: function (index) {
            ...
            var targetChild = imagePickerListRef.children[index];
            if (targetChild) {
                external_root_Yox_commonjs_yox_commonjs2_yox_amd_yox_default.a.dom.removeClass(targetChild, 'bell-drag-enter-active');
            }
        },
