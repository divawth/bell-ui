...
module.exports = (function(){var $0=void 0,$1=null,$2=!0,$3=!1,$4=function(__h){return __h.length-1};return function(_a,_b,_c,_d,_e,_f,_g,_h,_i,_j,_k,_l,_m,_n,_o,_p,_q,_r,_s,_t,_u,_v,_w,_x,_y,_z,__a,__b,__c,__d,__e,__f,__g,__l,__m,__j,__k){__j[__j.length]=__k[__k.length]=_b({context:_x,isComponent:$2,props:{className:'bell-checkbox-group'+(_o('className',__l.className).value?' '+_w(_o('className',__l.className).value):'')},tag:'Space',type:4},function(__i){_o('vertical',__l.vertical).value?(_c(__i,'props',$2,'vertical'),_c(__i,'props','start','align'),_c(__i,'props',_o('CHECKBOX_GAP_VERTICAL',__l.CHECKBOX_GAP_VERTICAL).value,'size')):(_c(__i,'props',$2,'autoWrap'),_c(__i,'props','center','align'),_c(__i,'props',[_o('CHECKBOX_GAP_HORIZONTAL',__l.CHECKBOX_GAP_HORIZONTAL).value,_o('CHECKBOX_GAP_VERTICAL',__l.CHECKBOX_GAP_VERTICAL).value],'size'));_o('style',__l.style).value?_c(__i,'props',_o('style',__l.style).value,'style'):$0},{$slot_children:function(__j,__k){_j('$slot_'+'children',__j)}})}})();
