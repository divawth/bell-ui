...
To use the `cssesc` binary in your shell, simply install cssesc globelly using npm:
...
After cloning this repository, run `npm install` to install the dependencies needed for development and testing. You may want to install Istanbul _globelly_ using `npm install istanbul -g`.
